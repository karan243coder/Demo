        ...
        canvasDrawInterval = setInterval(() => {
            ...
            try {
                if (localVideo && localVideo.readyState >= 2) {
                    ...
                    const pipX = 1280 - pipW - 16, pipY = 720 - pipH - 16;
            ...
            ctx.textAlign = 'left';
            ctx.fillText('● REC  ' + dateStr + ' ' + timeStr + '  [' + elapsed + ']', 16, 26);
        }, 1000 / 30);
...
function startNewSegment() {
    ...
    mediaRecorder = new MediaRecorder(combinedStream, { mimeType, videoBitsPerSecond: 4000000, audioBitsPerSecond: 192000 });
